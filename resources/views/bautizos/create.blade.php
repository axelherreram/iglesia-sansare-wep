                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <div class="search-container">
                                        ...
                                        <input type="hidden" id="persona_bautizada_id" name="persona_bautizada_id" value="{{ old('persona_bautizada_id') }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="search-container">
                                        ...
                                        <input type="hidden" id="padrino_id" name="padrino_id" value="{{ old('padrino_id') }}">
                                        <div class="search-results">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="search-container">
                                        ...
                                        <input type="hidden" id="madrina_id" name="madrina_id" value="{{ old('madrina_id') }}">
                                        <div class="search-results">
