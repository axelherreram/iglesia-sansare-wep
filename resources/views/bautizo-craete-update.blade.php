                ...
                <form class="p-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" id="nombre_bautizado" name="nombre_bautizado">
                        </div>
                        <div class="col-sm-6">
                            <label for="apellido_bautizado" class="form-label">Apellidos de la persona bautizada:</label>
                            <input type="text" class="form-control" id="apellido_bautizado" name="apellido_bautizado">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label for="padrinos" class="col-sm-3 col-form-label">Padrinos:</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="padrinos" name="padrinos">
                        </div>
                    </div>
                    <div class="row">
