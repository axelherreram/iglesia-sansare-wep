            ...
            <div class="personas-card">
                ...
                <div class="search-section">
                    ...
                    <form action="{{ route('comuniones.index') }}" method="GET">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <input type="text" class="search-input" name="search" placeholder="Ingrese nombre, apellido o CUI" 
                                ...
                                <tbody>
                                    @foreach($comuniones as $comunion)
                                        <tr>
                                            ...
                                            <td>{{ $comunion->personaParticipe->nombres }} {{ $comunion->personaParticipe->apellidos }}</td>
                                            ...
                                            <td>
                                                <div class="action-buttons">
                                                    <a href="{{ route('comuniones.show', $comunion->comunion_id) }}" class="btn-view">
                                                        <i class="lni lni-eye"></i> Ver
                                                    </a>
                                                    <a href="{{ route('comuniones.edit', $comunion->comunion_id) }}" class="btn-edit">
