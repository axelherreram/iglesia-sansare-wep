            ...
            <div class="info-section">
                <form id="edit-form" action="{{ route('casamientos.update', $casamiento->casamiento_id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="nombre_esposa" class="form-label required-field">Nombre de la Esposa:</label>
                                <div class="input-icon">
                                    <i class="lni lni-user"></i>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" class="form-control" id="edad_esposa" name="edad_esposa" 
                                        value="{{ old('edad_esposa', $casamiento->edad_esposa) }}">
                                </div>
                                @error('edad_esposa')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" class="form-control" id="nombre_parroco" name="nombre_parroco" 
