            ...
            <div class="form-body">
                <form action="{{ route('casamientos.store') }}" method="POST">
                    ...
                    <div class="section-card">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="edad_esposo" class="form-label">Edad:</label>
                                <div class="input-icon">
                                    <i class="lni lni-graduation"></i>
                                    <input type="number" class="form-control" id="edad_esposo" name="edad_esposo"
                                        value="{{ old('edad_esposo') }}" placeholder="Edad">
                                </div>
                                @error('edad_esposo')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="feligresia_esposo" class="form-label">Feligresía:</label>
                                <div class="input-icon">
                                    <i class="lni lni-church"></i>
                                    <input type="text" class="form-control" id="feligresia_esposo" name="feligresia_esposo"
                                        value="{{ old('feligresia_esposo') }}" placeholder="Feligresía">
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="search-container">
                                    ...
                                    <input type="hidden" id="padre_esposo_id" name="padre_esposo_id" value="{{ old('padre_esposo_id') }}">
                                    <div class="search-results">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="search-container">
                                    ...
                                    <input type="hidden" id="madre_esposo_id" name="madre_esposo_id" value="{{ old('madre_esposo_id') }}">
                                    <div class="search-results">
                    ...
                    <div class="section-card">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="edad_esposa" class="form-label">Edad:</label>
                                <div class="input-icon">
                                    <i class="lni lni-graduation"></i>
                                    <input type="number" class="form-control" id="edad_esposa" name="edad_esposa"
                                        value="{{ old('edad_esposa') }}" placeholder="Edad">
                                </div>
                                @error('edad_esposa')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="feligresia_esposa" class="form-label">Feligresía:</label>
                                <div class="input-icon">
                                    <i class="lni lni-church"></i>
                                    <input type="text" class="form-control" id="feligresia_esposa" name="feligresia_esposa"
                                        value="{{ old('feligresia_esposa') }}" placeholder="Feligresía">
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="search-container">
                                    ...
                                    <input type="hidden" id="padre_esposa_id" name="padre_esposa_id" value="{{ old('padre_esposa_id') }}">
                                    <div class="search-results">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="search-container">
                                    ...
                                    <input type="hidden" id="madre_esposa_id" name="madre_esposa_id" value="{{ old('madre_esposa_id') }}">
                                    <div class="search-results">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <div class="search-container">
                                    ...
                                    <input type="hidden" id="sacerdote_id" name="sacerdote_id" value="{{ old('sacerdote_id') }}">
                                    <div class="search-results">
                    ...
                    <div class="section-card">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="nombres_testigos" name="nombres_testigos" rows="3" 
                                    placeholder="Ingrese los nombres de los testigos">{{ old('nombres_testigos') }}</textarea>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        setupPersonSearch('esposo_search', 'esposo_id', 'select_esposo', 'M'); // Masculino
        setupPersonSearch('esposa_search', 'esposa_id', 'select_esposa', 'F'); // Femenino
        setupPersonSearch('padre_esposo_search', 'padre_esposo_id', 'select_padre_esposo', 'M'); // Masculino
        setupPersonSearch('madre_esposo_search', 'madre_esposo_id', 'select_madre_esposo', 'F'); // Femenino
        setupPersonSearch('padre_esposa_search', 'padre_esposa_id', 'select_padre_esposa', 'M'); // Masculino
