...
Route::get('/auth-header-footer-forgot-password', function () {
    return view('auth-header-footer-forgot-password');
});
Route::get('/auth-header-footer-reset-password', function () {
    return view('auth-header-footer-reset-password');
});
Route::get('/auth-header-footer-signin', function () {
    return view('auth-header-footer-signin');
});
Route::get('/auth-header-footer-signup', function () {
    return view('auth-header-footer-signup');
});
